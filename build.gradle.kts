...
loom {
    ...
    forge {
        ...
        mixinConfig("mixins.skripts.json")
    }
    mixin {
        defaultRefmapName.set("mixins.skripts.refmap.json")
    }
}
        ...
        manifest {
            attributes(
                mapOf(
                    ...
                    "TweakOrder" to "0",
                    "MixinConfigs" to "mixins.skripts.json",
                )
            )
        }
        dependsOn(shadowJar)
